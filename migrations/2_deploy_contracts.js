    ...
    deployer.deploy(Token, "0x46e7d71c5101956c26ed66f520c86c455d24b7a4", "0x46e7d71c5101956c26ed66f520c86c455d24b7a4", "0", "5000000000000000000000000").then(function() {
        return deployer.deploy(Whitelisting).then(function() {
            return deployer.deploy(Vesting, Token.address).then(function() {
                ...
                return deployer.deploy(privateSale, 1552917600, 1553090400, "0x46e7d71c5101956c26ed66f520c86c455d24b7a4", Whitelisting.address, Token.address, Vesting.address, 1553263200, "0", "5 000000 000000 000000 000000", "25000 000000 000000 000000").then(function(){
                    ...
                    return deployer.deploy(publicSale, 1553090400, 1553608800, "0x46e7d71c5101956c26ed66f520c86c455d24b7a4", Whitelisting.address, Token.address, Vesting.address, 1553781600, "0", "20 000000 000000 000000 000000", "100000 000000 000000 000000");
            });
        });
    });
};
